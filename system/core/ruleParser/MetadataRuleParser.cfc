...
component accessors="true" extends="BaseRuleParser" implements="IRuleParser" {
	...
	/**
	 * @hint I look the the object properties and add constraints if I recognize a constraint name as an property attribute
	 */
	...
	/**
	 * @hint I check for a "constraints" attributes in the object metadata and add those in as well.
	 */
