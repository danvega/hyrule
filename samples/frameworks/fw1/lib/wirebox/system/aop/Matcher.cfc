...
<!------------------------------------------- PUBLIC ------------------------------------------>
    ...
    <cffunction name="matchClass" output="false" access="public" returntype="boolean" hint="Matches a class to this matcher according to its criteria">    
		...
		<cfargument name="mapping" type="any" required="true" hint="The target mapping to match against to" colddoc:generic="wirebox.system.ioc.config.Mapping"/>
    	<cfscript>
    ...
    <cffunction name="andMatch" output="false" access="public" returntype="any" hint="AND this matcher with another matcher">    
    	<cfargument name="matcher" type="any" required="true" hint="The matcher to AND this matcher with" colddoc:generci="wirebox.system.aop.Matcher"/>
    	<cfscript>	    
    ...
    <cffunction name="orMatch" output="false" access="public" returntype="any" hint="OR this matcher with another matcher">    
    	<cfargument name="matcher" type="any" required="true" hint="The matcher to OR this matcher with" colddoc:generci="wirebox.system.aop.Matcher"/>
    	<cfscript>	    
