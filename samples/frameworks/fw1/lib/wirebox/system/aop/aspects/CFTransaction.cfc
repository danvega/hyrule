...
----------------------------------------------------------------------->
<cfcomponent implements="wirebox.system.aop.MethodInterceptor" 
    ...
    <cffunction name="invokeMethod" output="false" access="public" returntype="any" hint="Invoke an AOP method invocation">    
    	<cfargument name="invocation" type="any" hint="The method invocation object: wirebox.system.aop.MethodInvocation" colddoc:generic="wirebox.system.aop.MethodInvocation">
		<cfscript>
			var refLocal = {};
