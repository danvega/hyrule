...
----------------------------------------------------------------------->
<cfcomponent hint="The DSL builder for all ColdBox related stuff" implements="wirebox.system.ioc.dsl.IDSLBuilder" output="false">
	...
	<cffunction name="getDatasource" access="private" output="false" returnType="any" hint="I will return to you a datasourceBean according to the alias of the datasource you wish to get from the configstruct" colddoc:generic="wirebox.system.core.db.DatasourceBean">
		...
		if ( structKeyExists(datasources, arguments.alias) ){
			return createObject("component","wirebox.system.core.db.DatasourceBean").init(datasources[arguments.alias]);
		}
		</cfscript>
	</cffunction>
			...
			switch(thisTypeLen){
				...
				case 2: {
					...
					switch( thisLocationKey ){
						case "fwconfigbean" 		: { return createObject("component","wirebox.system.core.collections.ConfigBean").init( instance.coldbox.getColdboxSettings() ); }
						case "configbean" 			: { return createObject("component","wirebox.system.core.collections.ConfigBean").init( instance.coldbox.getConfigSettings() ); }
						case "mailsettingsbean"		: { return createObject("component","wirebox.system.core.mail.MailSettingsBean").init(argumentCollection=instance.coldbox.getSetting("mailSettings"));	}
